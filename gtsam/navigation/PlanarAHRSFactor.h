/**
 * Like AHRSFactor, but using Rot2 instead of Rot3, and without
 * the preintegrator: measurements are preintegrated by the gyro hardware.
 *
 ...
 * See AHRSFactor.
 */
class GTSAM_EXPORT PlanarAHRSFactor : public NoiseModelFactorN<Rot3, Rot3, Vector3> {
