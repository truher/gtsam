...
bool PreintegratedPlanarRotation::equals(const PreintegratedPlanarRotation& other,
    double tol) const {
...
namespace internal {
Rot3 IncrementalPlanarRotation::operator()(
...
void PreintegratedPlanarRotation::integrateGyroMeasurement(
  ...
  Matrix3 H_bias;
  internal::IncrementalPlanarRotation f{measuredOmega, deltaT, p_->body_P_sensor};
...
void PreintegratedPlanarRotation::integrateMeasurement(
    const Vector3& measuredOmega, const Vector3& biasHat, double deltaT,
...
Rot3 PreintegratedPlanarRotation::biascorrectedDeltaRij(const Vector3& biasOmegaIncr,
...
Vector3 PreintegratedPlanarRotation::integrateCoriolis(
